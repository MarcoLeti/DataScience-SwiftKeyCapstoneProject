...
```{r}
plotTopFeatures <- function(frequencyMatrix, wc = FALSE, n = 50, fill = "black") {
    ...
    if (!wc){
        ...
        wordcloud2(tempFrequencyMatrix)
    }
